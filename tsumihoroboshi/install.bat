...
.\aria2c.exe --file-allocation=none --continue=true --retry-wait 5 -m 0 https://gitlab.com/ItaloKnox/tsumihoroboshi/raw/master/Tsumihoroboshi-CG.7z
...
echo.
.\aria2c.exe --file-allocation=none --continue=true --retry-wait 5 -m 0 https://gitlab.com/ItaloKnox/tsumihoroboshi/raw/master/Tsumihoroboshi-Voices.7z
