...
def cleanCG():
    ...
    old_CompiledUpdate = "./HigurashiEp05_Data/StreamingAssets/CompiledUpdateScripts"
    
    if os.path.isdir(old_CG) and os.path.isdir(old_CGAlt):
        shutil.rmtree(old_CG)
        shutil.rmtree(old_CGAlt)

    for file in os.listdir("./HigurashiEp05_Data/StreamingAssets/CompiledUpdateScripts"):
