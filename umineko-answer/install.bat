...
.\temp\7za.exe x temp\UminekoChiru-Update* -aoa -bsp1 || echo ERROR during updates extraction. Check the game files are not in use. && goto :installFailed
...
echo Umineko5to8.exe --debug > "Umineko5to8_DebugMode.bat"
