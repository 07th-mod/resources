...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true -x 16 https://github.com/07th-mod/tatarigoroshi/releases/download/v4.0.0/Tatarigoroshi.Voice.and.Graphics.Patch.v4.0.1.zip
