...
echo.
timeout /t 1 > nul
powershell -command "(convertfrom-json (invoke-webrequest https://api.github.com/repos/07th-mod/tatarigoroshi/releases/latest).content).assets.browser_download_url | set-content patch.txt"
