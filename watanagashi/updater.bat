...
timeout /t 3 > nul
powershell -command "(convertfrom-json (invoke-webrequest https://api.github.com/repos/07th-mod/watanagashi/releases/latest).content).assets.browser_download_url | set-content remote.txt"
