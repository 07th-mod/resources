...
echo.
timeout /t 1 > nul
.\aria2c.exe --file-allocation=none --continue=true -x 16 https://github.com/07th-mod/himatsubushi/releases/download/v3.0.1/Himatsubushi.Voice.and.Graphics.Patch.v3.0.1.zip
